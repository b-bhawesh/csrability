...
<div id="page-wrapper">
	<div class="header"> 
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo e(route('auth.job.create')); ?>">Add Jobs </a></li>
	        ...
	        <div class="col-md-12">
	            <div class="panel panel-default">
                    ...
                    <div class="panel-body">
						...
						<?php echo csrf_field(); ?>
						<?php if(!empty($method)): ?> <?php echo method_field($method); ?> <?php endif; ?>
							...
							<div class="form-group">
								<div class="row">
								    ...
								    <div class="col-md-9">
								        <input type="text" class="form-control" name="job_title" value="<?php echo e($pageTitle); ?>" <?php echo e($prop); ?> maxlength="100" required >												
							        </div>
							    </div>
							</div>
							...
							<div class="form-group">
								<div class="row">
		        					...
		        					<div class="col-md-9">
		        						<input type="text" class="form-control" name="organisation" value="<?php echo e($pageTitle); ?>" <?php echo e($prop); ?> maxlength="100" required >
		    						</div>
		    					</div>
		    				</div>
		    				...
		    				<div class="form-group">
								<div class="row">
		        					...
		        					<div class="col-md-9">
		        						<input type="text" class="form-control" name="publish_date" value="<?php echo e($pageTitle); ?>" <?php echo e($prop); ?> maxlength="100" required readonly>
		    						</div>
		    					</div>
		    				</div>
		    				...
		    				<div class="form-group">
								<div class="row">			    						
		    						...
		    						<div class="col-md-9">
		        						<input type="text" class="form-control" name="closing_date" value="<?php echo e($pageTitle); ?>" <?php echo e($prop); ?> maxlength="100" required readonly>
		    						</div>
								</div>
							</div>
								...
								<div class="row">
								    ...
								    <div class="col-md-9">
										<select class="form-control select2" name="sectors[]" required multiple>
											...
											<option value="<?php echo e($k); ?>"><?php echo e($s); ?></option>
							...
							<div class="form-group" style="margin-top: 20px;">						
								<input type="submit" class="btn btn-primary" value="Submit" name="btn_btn_add_product"  <?php echo e($prop); ?>>
							</div>
					    </form>
				    </div>
				</div>
...
<?php echo $__env->make('admin.template.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/unilinki/public_html/csrability/resources/views/admin/pages/job/create.blade.php ENDPATH**/ ?>