                     ...
                     <div class="col-sm-6 d-flex justify-content-between justify-content-sm-end">
                        ...
                        <div class="dropdown">
                           ...
                           <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                              ...
                              <a class="dropdown-item" href="<?php echo e(route('user.login')); ?>">Login</a>
                  ...
                  <div class="container">
                     ...
                     <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav ml-auto text-uppercase">
                           ...
                           <li class="nav-item"><a class="nav-link  active" href="<?php echo e(route('jobs')); ?>">Jobs</a></li>
        ...
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="<?php echo e(route('user.login.access')); ?>">
               ...
               <div class="row">
                  ...
                  <div class="col-sm-12">
                     ...
                     <ul
                        ...
                        <li class="nav-item"><a class="nav-link text-white" href="<?php echo e(route('jobs')); ?>">Jobs</a></li>
...
<?php /**PATH /home/unilinki/public_html/csrability/resources/views/front/login.blade.php ENDPATH**/ ?>