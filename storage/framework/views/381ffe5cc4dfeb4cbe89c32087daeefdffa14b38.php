			...
			<div class="border-bottom py-3 mb-3 jobDetail">
				<header class="d-flex flex-column flex-sm-row">
					...
					<div class="d-flex flex-column">
						...
						<h6 class="text-dark font-weight-bold"><?php echo e($c->job_title); ?></h6>
						<h6 class="font-weight-normal mb-4"><?php echo e($c->organisation); ?></h6>
						<div class="d-flex">
					...
					<div class="ml-sm-auto d-flex align-items-start moreDetails">
						...
						<a href="#"
							...
							class="text-dark pl-3 py-3"> <span class="d-block">Last date to
								apply</span> <strong><?php echo e(\Carbon\Carbon::parse($c->closing_date)->format('d-M-Y')); ?></strong>
				...
				<div class="d-flex align-items-center pt-3 pt-sm-0">
					...
					<p class="mr-3"><?php echo e($c->job_description); ?></p>

					<a href="<?php echo e($c->id); ?>" class="btn btn-outline-primary px-4">Save</a>
					<?php if(Auth::check()): ?>
					    <a href="<?php echo e(url('/application/'.$c->id)); ?>" class="btn btn-primary px-4 mx-5">Apply</a>
					<?php else: ?>
					    <a href="<?php echo e(route('user.login')); ?>" class="btn btn-primary px-4 mx-5">Apply</a>
					<?php endif; ?>
...
<?php echo $__env->make('front.template.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/unilinki/public_html/csrability/resources/views/front/pages/job/index.blade.php ENDPATH**/ ?>