	                ...
	                <div class="panel-body">
	                    <div class="table-responsive">
	                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								<tr>
									<td><?php echo e(++$k); ?></td>
									<td><?php echo e($u->video_title); ?></td>
									<td><?php echo e($u->video); ?></td>
									<td>
										<a href="<?php echo e(route('auth.video.edit', $u->id)); ?>"><i class="fa fa-pencil"></i> Edit</a>							
									</td>
								</tr>
...
<?php echo $__env->make('admin.template.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/unilinki/public_html/csrability/resources/views/admin/pages/video/index.blade.php ENDPATH**/ ?>