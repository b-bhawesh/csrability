...
<div id="page-wrapper">
	<div class="header"> 
        <h1 class="page-header">
            Add Rfp <small>These are Rfps.</small>
        </h1>
		<ol class="breadcrumb">
						...
						<?php if(!empty($method)): ?> <?php echo method_field($method); ?> <?php endif; ?>
							...
							<div class="form-group">
								<div class="row">
								    ...
								    <div class="col-md-9">
								        <input type="text" class="form-control" name="rfp_title" value="<?php echo e($pageTitle); ?>" <?php echo e($prop); ?> maxlength="100" required >												
							        </div>
							    </div>
							</div>
...
<?php echo $__env->make('admin.template.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/unilinki/public_html/csrability/resources/views/admin/pages/rfp/create.blade.php ENDPATH**/ ?>