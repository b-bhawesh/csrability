            ...
            <div class="row">
                ...
                <div class="col-sm-6 d-flex justify-content-between justify-content-sm-end">
                    ...
                    <?php if(Auth::check()): ?>
	                    ...
	                    <div class="dropdown">
	                        <button class="btn dropdown-toggle rounded-0 darkPrimary text-white" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <?php echo e(Auth::user()->name); ?> </button>
	                ...
	                <?php else: ?>
	                    ...
	                    <div class="dropdown">
							<button class="btn dropdown-toggle rounded-0 darkPrimary text-white" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Member Login</button>

							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
								<a class="dropdown-item" data-toggle="modal" data-target="#myModal">Individual</a> 
								<a class="dropdown-item"data-toggle="modal" data-target="#myModal">Institution</a>
							</div>
						</div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto text-uppercase">
						...
						<li class="nav-item"><a class="nav-link" href="#">RFP</a></li>
						<li class="nav-item"><a class="nav-link" href="#">News</a></li>
						<li class="nav-item"><a class="nav-link" href="#">Events</a></li>
						<li class="nav-item"><a class="nav-link" href="<?php echo e(route('jobs')); ?>">Jobs</a></li>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="social-login">
					...
					<a href="<?php echo e(url('auth/facebook')); ?>"><img

						src="<?php echo e(asset('assets/img/fb.png')); ?>"></a> <a

						href="<?php echo e(url('auth/linkedin')); ?>"><img

						src="<?php echo e(asset('assets/img/linkedin.png')); ?>"></a> <a

						href="<?php echo e(url('auth/google')); ?>"><img

						src="<?php echo e(asset('assets/img/google.png')); ?>"></a>
				...
				<form action = "<?php echo e(route('user.register')); ?>" method="post"  class="register-form">
						...
						<div class="row">
						<div class="col-md-12">
							<input type="eamil" name="email" class="form-control" placeholder="Email" required>
						</div>
						</div>
...
</div><?php /**PATH /home/unilinki/public_html/csrability/resources/views/front/partials/header.blade.php ENDPATH**/ ?>