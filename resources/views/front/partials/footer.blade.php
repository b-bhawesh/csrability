		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<ul
					...
					<li class="nav-item"><a class="nav-link text-white" href="#">Our
							Work</a></li>
			...
			<div class="col-sm-12">
				...
				<p class="text-white text-center mb-5">Copyright &copy; 2019 CSR.
			...
			<div class="col-sm-12">
				...
				<ul
					class="list-unstyled d-flex justify-content-center mb-0 socialMedia">

					<li class="mr-4 mx-sm-2 pt-1"><a href="#" class="text-white"><i
