            ...
            <div class="row">
                ...
                <div class="col-sm-6 d-flex justify-content-between justify-content-sm-end">
                    ...
                    @if (Auth::check())
	                    ...
	                    <div class="dropdown">
	                        <button class="btn dropdown-toggle rounded-0 darkPrimary text-white" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> {{Auth::user()->name}} </button>
