		...
		<div class="col-lg-8">
			...
			<div class="border-bottom py-3 mb-3 jobDetail">
				...
				<div class="d-flex align-items-center pt-3 pt-sm-0">
					...
					<a href="{{ $c->id }}" class="btn btn-outline-primary px-4">Save</a>
					@if (Auth::check())
					    <a href="{{url('/application/'.$c->id)}}" class="btn btn-primary px-4 mx-5">Apply</a>
					@else
					    <a href="{{ route('user.login') }}" class="btn btn-primary px-4 mx-5">Apply</a>
					@endif
