	...
	@csrf()
		...
		<div class="form-group">
			<div class="row">
			    ...
			    <div class="col-md-9">
			        <input type="text" class="form-control" name="user_id" value="{{ $userId }}" maxlength="100" readonly="">												
		        </div>
		    </div>
		</div>
		...
		<div class="form-group">
			<div class="row">
			    ...
			    <div class="col-md-9">
			        <input type="text" class="form-control" name="job_title" value="{{ trim($adtitle) }}" maxlength="100" readonly="">											
		        </div>
		    </div>
		</div>
		...
		<div class="form-group">
			<div class="row">
			    ...
			    <div class="col-md-9">
			        <input type="text" class="form-control" name="publish_date" value="{{ trim($adpublish_date) }}" maxlength="100" readonly="">											
		        </div>
		    </div>
		</div>
		...
		<div class="form-group">
			<div class="row">
			    ...
			    <div class="col-md-9">
			        <input type="text" class="form-control" name="closing_date" value="{{ trim($adclosing_date) }}" maxlength="100" readonly="">											
		        </div>
		    </div>
		</div>
		...
		<div class="form-group">
			<div class="row">
			    ...
			    <div class="col-md-9">
			        <input type="text" class="form-control" name="organisation" value="{{ trim($adorganisation) }}" maxlength="100" readonly="">											
		        </div>
		    </div>
		</div>
