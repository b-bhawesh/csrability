...
<div id="page-wrapper">
	<div class="header"> 
		...
		<ol class="breadcrumb">
			...
			<li><a href="{{ route('auth.rfp.index') }}">Edit Rfps </a></li>
						...
						<form action="{{ $action }}" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">					
								<div class="row">
									...
									<div class="col-md-9">
									    <input type="text" class="form-control" name="rfp_title" value="{{ trim($rtitle) }}" maxlength="100" required >	
									</div>											
								</div>
							</div>
							...
							<div class="form-group">
								<div class="row">
								    ...
								    <div class="col-md-9">
							        	<textarea id="summernote" name="rfp_description">{{ trim($description) }}</textarea>	
							        </div>											
								</div>
							</div>
							...
							<div class="form-group">
								<div class="row">    						
		    						...
		    						<div class="col-md-9">
				                        ...
				                        @if($company_image)
				                        <img src="{{ asset('storage/rfp-company-logo/'.$company_image)}}" class="organisation-logo">
				                        @else
