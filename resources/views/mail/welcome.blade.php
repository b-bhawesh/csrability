...
<body style="margin: 0px;">
	...
	<p style="margin: 10px;padding-left: 40px;">Then yoou can login using your email {{ $email }} as your username.<br> Please note that password and username are case-sensitive.</p>
